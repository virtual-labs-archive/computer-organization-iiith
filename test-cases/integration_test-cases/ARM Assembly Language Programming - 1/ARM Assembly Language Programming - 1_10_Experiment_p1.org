...
* Test Steps
  ...
  4. Click on the run button and then click on the execute button

* Expected result
  1. Experiment page should be opened
  2. Content should be present with no distortions and Junk characters
  3. The selected file or program should be displayed on the screen
  4. When we click on the run button,an simulation result should be displayed in the execute field
