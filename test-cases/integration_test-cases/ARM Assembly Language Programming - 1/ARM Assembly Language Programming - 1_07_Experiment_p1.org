...
* Test Steps
  ...
  3. Don't enter the code in the editor and click on the run button

* Expected result
  1. Experiment page should be opened
  2. Content should be present with no distortions and Junk characters
  3. An error message should be displaayed on the screen as to type the code in the editor field
