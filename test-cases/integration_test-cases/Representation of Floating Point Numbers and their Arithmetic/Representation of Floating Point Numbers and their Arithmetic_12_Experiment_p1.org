...
* Test Steps
  ...
  4. Select 'Quick tutorial and guide' option
  5. Click on the next button and then click on the back button

* Expected result
  1. Experiment page should be opened
  2. Content should be present with no distortions and Junk characters
  3. It should redirect to a new tab with the simulation process
  4. A tutorial should be displayed on the screen and when we click on the next button the next slide should be displayed on the screen and when we click on the back button the previous slide should be displayed on the screen
