...
db.auth_user.password.comment='No password for guest account'
...
db.define_table('programs',
	Field('n','integer',default=64),
        Field('B','integer',default=2),
...
db.define_table('graph_cache',
        ...
        Field('l2_line_size','integer',default=64),
	Field('n','integer'),
	Field('ans1','string',requires=IS_LENGTH(1000)),
	Field('ans2','string',requires=IS_LENGTH(1000)),
	Field('ans3','string',requires=IS_LENGTH(1000)),
	Field('ans','string',requires=IS_LENGTH(3000)),
	Field('xticks','string',requires=IS_LENGTH(3000)),
	)
