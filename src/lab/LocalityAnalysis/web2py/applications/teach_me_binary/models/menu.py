...
response.subtitle = T('Isomorphic Binary Addition')
response.meta.author = 'Ravi Agarwal,IIIT Hyderabad'
response.meta.description = 'Teaches you binary addition, signed and unsigned'
response.meta.keywords = 'CSO IIIT binary'
