...
$css_js   = "http://deploy.virtual-labs.ac.in/labs/cse11/"; 
$lab_url  = "http://deploy.virtual-labs.ac.in/labs/cse11/index.php";
$exp_url  =  "http://deploy.virtual-labs.ac.in/labs/cse11/FloatingPointNumbers/index.php";
$base_url = $exp_url;
